...
$conn = new mysqli($servername, $username, $password,$db);
  if ($conn->connect_error) {
    ...
    $company = $_POST['company']; 
    $sql1 = "SELECT item_name AS total FROM items WHERE location = '$company'";
    $result1 = $conn->query($sql1);
    ...
    $sql3 = "SELECT name AS total,position as position,location as location FROM personels WHERE location = '$company'";
    $result3 = $conn->query($sql3);
    if ($result3->num_rows > 0) {
        $data['result3'] = array(); // Initialize an empty array
        $data['result9'] = array(); // Initialize an empty array
    ...
    $sql4 = "SELECT name AS total FROM category WHERE location = '$company'";
    $result4 = $conn->query($sql4);
    if ($result4->num_rows > 0) {
        $data['result4'] = array(); // Initialize an empty array
    ...
    $sql6 = "SELECT sponsors AS total,company as company FROM sponsors WHERE company = '$company'";
    $result6 = $conn->query($sql6);
    if ($result6->num_rows > 0) {
        $data['result8'] = array(); // Initialize an empty array
        $data['result12'] = array(); // Initialize an empty array
