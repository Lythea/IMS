    ...
    if($property =='Defective Products' ){
        ...
        if ($result->num_rows > 0) {
          ...
          if ($result1->num_rows > 0) {
            ...
            $sql = "SELECT quantity FROM defective WHERE item_id ='$item_id' AND companyownership = '$location'";
            $result = $conn->query($sql);
            ...
            if ($currentQuantity >= 1) {
                ...
                $updateSql = "UPDATE defective SET quantity = '$newQuantity' WHERE item_id ='$item_id' AND companyownership = '$location'";
        ...
        // Select the current quantity for the given item and location
            ...
            $insertSql = "INSERT INTO defective (item_id, item_name, quantity, companyownership) VALUES ('$item_id', '$itemname', '$quantity', '$location')";
